...
public class ConvertJsonToPojo 
{
    ...
    public void ConvertRespToJson()
    {
    	try 
    	{
            ...
            ConvertRespJsonToPOJO.convertResponseJSON(inputRespJson.toURI().toURL(), outputRespPojoDir, resp_pkg, inputRespJson.getName().replace(".json", ""));  
        } 
    	catch (IOException e) 
    	{  
    ...
    {
    	new ConvertJsonToPojo("post").ConvertRespToJson();
	}
}
