...
@CucumberOptions(features = {"src/test/resources/CvShortlisterFeatures", "src/test/resources/RequestAndUIFeatures"}, glue = { "com.restassured.stepdef",
		"com.restassured.setup" } // Path of step definition file
		, plugin = { "pretty", "html:target/cucumber-reports/cucumber-html-report",
				"json:target/cucmber-reports/CucumberTestReport.json", "rerun:target/cucmber-reports/rerun.txt"
		...
		, tags = "@SmokeUI and not @datatable and not @GetUser and not @Candidates and not @SaveUser"
